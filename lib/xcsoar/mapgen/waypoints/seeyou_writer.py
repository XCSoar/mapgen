...
def __compose_line(waypoint):
    ...
    if waypoint.cup_type:
        ...
        if waypoint.type == "outlanding":
            str += "3,"
        elif waypoint.type == "glider_site":
            str += "4,"
            ...
            if waypoint.surface and waypoint.surface in [
                ...
                str += "2,"
        elif waypoint.type == "mountain pass":
            str += "6,"
        elif waypoint.type == "mountain top":
            str += "7,"
        elif waypoint.type == "tower":
            str += "8,"
        elif waypoint.type == "tunnel":
            str += "13,"
        elif waypoint.type == "bridge":
            str += "14,"
        elif waypoint.type == "powerplant":
            str += "15,"
        elif waypoint.type == "castle":
            str += "16,"
        elif waypoint.type.endswith("junction"):
            str += "17,"
        elif waypoint.type.endswith("cross"):
            str += "17,"
        else:
            str += "1,"
    else:
